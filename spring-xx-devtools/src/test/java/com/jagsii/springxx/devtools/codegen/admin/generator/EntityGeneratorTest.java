...
class EntityGeneratorTest extends SpringTests {
    ...
    void generate() throws Exception {
        ...
        entity.setBaseEntity(new JavaType("com.example.common.BaseEntity"));
        ...
        assertThat(actual.getPath()).isEqualTo("\\workspace\\foo\\src\\main\\java\\com\\example\\foo\\modules\\system\\entity\\User.java");
        try (InputStream expected = new DefaultResourceLoader().getResource("classpath:/data/User.java.txt").getInputStream()) {
